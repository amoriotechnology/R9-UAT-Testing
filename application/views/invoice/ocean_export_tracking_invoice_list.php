...
<a class="btn  btn-sm" style="background-color: #3ca5de; color: #fff;"  data-toggle="modal" data-target="#emailmodal" onclick="oceanexportmail(<?php echo  $arr['ocean_export_tracking_id'];  ?>,'ocean_export_tracking','ocean_export_tracking_id')"><i class="fa fa-envelope" aria-hidden="true" ></i></a>
